...
public class SMGenerator {
    ...
    private static String[] UserHeaders = {
        "SUBTITLE",
        "TITLETRANSLIT",
        "SUBTITLETRANSLIT",
        "ARTISTTRANSLIT",
    ...
    public static BufferedWriter GenerateSM(
        float BPM,
        float startTime,
        File songfile,
        String outputdir,
        ...
        try {
            ...
            buff =
                Header
                    .replace("$TITLE;", AutoStepper.getArg(args, "TITLE", shortName) + ";")
                    .replace("$BANNER", AutoStepper.getArg(args, "BANNER", imgFileName))
                    ...
                    .replace(
                        "$STARTTIME",
                        AutoStepper.getArg(args, "STARTTIME", Float.toString(startTime + AutoStepper.STARTSYNC))
                    )
